...
exports.Logitrics = void 0;

var Logitrics =
/** @class */
function () {
  function Logitrics() {
    this.title = 'logitrics';
    this.eventProperties = {};
    this.window = this;
  }

  Logitrics.prototype.setEventTimeStamp = function () {
    this.eventProperties['$timestamp'] = new Date();
  };

  Logitrics.prototype.trackEvent = function (name, customEventProperties) {
  ...
  Logitrics.prototype.initialize = function (payload) {
    this.initService.initialize(payload);
  };

  Logitrics.prototype.identifyUser = function (payload) {
...
//# sourceMappingURL=/logitrics-parcel.77de5100.js.map
